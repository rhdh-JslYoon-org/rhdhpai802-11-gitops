...
# Application
An application built from https://github.com/rhdh-JslYoon-org/rhdhpai802-11 will be stored in [quay.io/rh-ee-lyoon/rhdhpai802-11](https://quay.io/rh-ee-lyoon/rhdhpai802-11) and deployed through GitOps. This application is accessible on port **8501**.